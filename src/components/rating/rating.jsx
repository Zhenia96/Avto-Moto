...
function Rating({ className, size = 100, value, labelTitls, onRatingChange }) {
  ...
  return (
    <fieldset className={`${className ?? ''} rating`} style={{ fontSize: size + 'px' }}>
      <label className='rating__star' htmlFor='star-1' title={labelTitls[0] ?? STAR_POSITION.FIRST}></label>
      ...
      <label className='rating__star' htmlFor='star-2' title={labelTitls[1] ?? STAR_POSITION.SECOND}></label>
      ...
      <label className='rating__star' htmlFor='star-3' title={labelTitls[2] ?? STAR_POSITION.THIRD}></label>
      ...
      <label className='rating__star' htmlFor='star-4' title={labelTitls[3] ?? STAR_POSITION.FORTH}></label>
      ...
      <label className='rating__star' htmlFor='star-5' title={labelTitls[4] ?? STAR_POSITION.FIFTH}></label>
...
Rating.propTypes = {
  ...
  labelTitls: PropTypes.arrayOf(PropTypes.string),
