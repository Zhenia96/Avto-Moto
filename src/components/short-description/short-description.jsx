...
function ShortDescription({ className }) {
  return (
    <dl className={`${className} short-description`}>
      <div className='short-description__item'>
        <dt className='short-description__name'>
          <img
            src='img/engines_type-icon.svg'
            alt='Тип двигателя'
            width='53'
            height='40'
          />
